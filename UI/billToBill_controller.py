...
class BillBillConverter(QStackedWidget):
    ...
    def go_to_cb_insert_bill(self, _=None):
        ...
        print("[BillBillConverter] go_to_cb_insert - Insert screen prepared")
        print(f"[BillBillConverter] User selected bill: {self.selected_amount}")
    ...
    def go_to_cb_insertcoins(self, _=None):
        ...
        print("[BillBillConverter] go_to_cb_insertcoins called - navigating index 4")
    ...
    def go_to_transFee(self, _=None):
        ...
        print("[BillBillConverter] go_to_transFee - Updated dashboard values")
    ...
    def update_dashboard_checkboxes(self):
        ...
        current_storage = self.bill_handler.storage.get_storage()
        ...
        print(f"[BillBillConverter] update_dashboard_checkboxes - "
    ...
    def start_coin_insertion(self):
        ...
        print(f"[BillBillConverter] Coin insertion started (required_fee=P{self.selected_fee}")
    ...
    def on_single_coin_inserted(self, denomination, denom_count, total_value):
        ...
        print(f"[BillBillConverter] on_single_coin_inserted: denom={denomination}, "
    ...
    def on_coins_finalized(self, total_value):
        ...
        print(f"[BillBillConverter] on_coins_finalized - total_value=P{total_value}, "
            f"excess_coins={self.excess_coins}, to_dispense={self.total_amount_to_dispense}")
        ...
        if self.inserted_coin_amount >= self.selected_fee:
            ...
            print("[BillBillConverter] Coins less than fee but worker finished - waiting for user action")
    ...
    def on_coin_timeout(self):
        ...
        """
        print("[BillBillConverter] Coin insertion timer expired - evaluating...")
        ...
        if self.inserted_coin_amount < self.selected_fee:
            ...
            print("[BillBillConverter] Timeout with insufficient coins - auto deducting fee from bill")
            ...
            print("[BillBillConverter] Timeout but fee covered - proceeding to dashboard")
            QTimer.singleShot(1000, lambda: self.go_to_cb_dashboard2())

        print(f"[BillBillConverter] Timeout final state: "
    ...
    def on_dispense_finished(self):
        print("[BillBillConverter] Dispensing finished")
